...
@Autonomous(name = "RED SIMPLE 11161", group = "Red")
public class RedAuto11161 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeInInit()) {
            telemetry.addData("Status", "Ready - RED");
            telemetryAprilTag();
            telemetry.update();
        }
        ...
        // 1. READ OBELISK (Capture ID 21, 22, or 23)
        int detectedId = -1;
        ...
        // 6. STRAFE RIGHT (New movement)
        strafeRightTime(0.5, 2.0);
    ...
    public void turnTime(double power, double seconds) {
        // Turning Right (CCW): Left motors forward, Right motors back
        setDrivePower(power, power, -power, -power);
        sleep((long)(seconds * 1000));
        setDrivePower(0, 0, 0, 0);
    }
    ...
    /**
     * Strafe Right: Front Left Forwards, Front Right Backwards,
     * Back Left Backwards, Back Right Forwards
     */
    public void strafeRightTime(double power, double seconds) {
        setDrivePower(power, -power, -power, power);
        sleep((long)(seconds * 1000));
        setDrivePower(0, 0, 0, 0);
    }
