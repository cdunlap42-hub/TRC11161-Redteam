...
@Autonomous(name = "RED NEAR 11161", group = "Red")
public class RedAutoNear11161 extends LinearOpMode {
    ...
    /* Constants */
    static final double REVOLVER_STEP_TIME = 0.530;
    ...
    public void runOpMode() {
        ...
        // 2. TURN (Power, Seconds) - Positive power turns CW (Right)
    ...
    public void turnTime(double power, double seconds) {
        // Turning Right (CW): Left motors back, Left motors forward
        setDrivePower(power, power, -power, -power);
        sleep((long)(seconds * 1000));
        setDrivePower(0, 0, 0, 0);
    }
